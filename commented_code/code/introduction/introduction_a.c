...
/*   Updated: 2023/08/13 01:14:19 by vde-frei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	 ...
	 * note that here we don't want more 'Nodes'
	 * in next, so we can assign 'NULL' to *.next' 
	 */
	...
	//Remember to free variable that you use malloc
	free(root.next);
	return (0);
}
